...
{
	GEngine->AddOnScreenDebugMessage(-1, 15, FColor::Orange, TEXT("Hit"));
...
{
	GEngine->AddOnScreenDebugMessage(-1, 15, FColor::Orange, TEXT("Start Focus"));
}

void AInteractableBase::EndFocus_Implementation()
{
	GEngine->AddOnScreenDebugMessage(-1, 15, FColor::Orange, TEXT("End Focus"));
}
